...
export const metadata: Metadata = {
  ...
  title: {
    default: "Nexable | AI-Powered Online Course Creation Platform",
    template: "%s | Nexable",
  },
  description: "Create engaging online courses with Nexable's AI-powered platform. Design, manage, and share personalized learning experiences effortlessly.",
  keywords: [
    "AI course creation",
  ...
  openGraph: {
    ...
    url: defaultUrl,
    siteName: "Nexable",
    title: "Nexable | AI-Powered Online Course Creation Platform",
    description: "Create engaging online courses with Nexable's AI-powered platform. Design, manage, and share personalized learning experiences effortlessly.",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Nexable - AI-Powered Course Creation",
      },
    ],
  },
  twitter: {
