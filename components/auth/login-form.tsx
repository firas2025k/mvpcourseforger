    ...
    <div className={cn("w-full", className)} {...props}>
      <Card className="bg-white dark:bg-gray-800/80 shadow-xl border-gray-200 dark:border-gray-700/60 rounded-xl overflow-hidden">
        <CardHeader className="space-y-1 text-center p-6 bg-gray-50 dark:bg-gray-800/50 border-b dark:border-gray-700/60">
          <CardTitle className="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-50">Welcome Back!</CardTitle>
        ...
        <CardContent className="p-6 sm:p-8">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-sm text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 underline-offset-4 hover:underline transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <Button 
              ...
              disabled={isLoading}
            >
              {isLoading && email.includes('@') ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null} {/* Basic check to show spinner only for Google */} 
